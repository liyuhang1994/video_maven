 ...
 * @date 2017年12月13日 下午3:19:21
 * 
 */
public class MailUtil {
	// 修改为自己的qq邮箱账号
	private static String myEmailAccount = "649869350@qq.com";
	// 修改为自己的邮箱授权码
	private static String myEmailPassword = "jkuuygdgyigxbcii";
	...
	public static void send(String receive, String title, String body) throws Exception {
		 ...
		 * 连接, 需要改为对应邮箱的 SMTP 服务器的端口, 具体可查看对应邮箱服务的帮助,
		...
		props.setProperty("mail.smtp.socketFactory.port", smtpPort);// 2.
																	// 根据配置创建会话对象,
																	// 用于和邮件服务器交互
	...
	private static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String title,
		...
		// 4. Subject: 邮件主题message.setSubject(title, "UTF-8");
