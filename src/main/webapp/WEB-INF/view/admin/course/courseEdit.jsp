	...
	<div class="container">
		...
		<div class="form">
			<form class="form-horizontal"
				action="${pageContext.request.contextPath }/admin/course/courseEdit.action">
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">标题</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3"
							placeholder="${course.course_name }" name="course_name">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" name="subject_id" name="subject_id">
							<c:forEach items="${sub }" var="sub">
								<option value="${sub.id }"
									${course.subject_name ==sub.subject_name  ? "selected" :"" }>${sub.subject_name }</option>
							</c:forEach>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" cols="10" rows="5"
							placeholder="${course.course_descr}" name="course_descr"></textarea>
					</div>
				</div>
